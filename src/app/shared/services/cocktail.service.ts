...
export class CocktailService {
  ...
  public cocktails: BehaviorSubject<Cocktail[]> = new BehaviorSubject(new Array<Cocktail>());
  ...
  constructor(private http: HttpClient) {
    this.http.get<Cocktail[]>('https://cocktails-angular-36eae.firebaseio.com/cocktails.json')
    .pipe(
      filter(cocktails => cocktails !=null),
    )
    .subscribe(cocktails => {
